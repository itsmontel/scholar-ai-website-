# Chrome Web Store Listing (Keyword-Spam Compliant)

Use this copy when editing your extension's listing in the Chrome Web Store dashboard. Avoid listing brand names (YouTube, TikTok, etc.)—describe the function instead.
