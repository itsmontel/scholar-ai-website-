...
const GOAL_CONFIG: Record<OnboardingGoal, { title: string; steps: TutorialStep[] }> = {
  ...
  study: {
    ...
    steps: [
      { instruction: 'Paste your notes', detail: 'Drop your textbook, notes, or article — one click generates a Study Pack (lesson & flashcards free; quiz, crossword, Crater Blast & Word Tower with Pro)', emoji: '📚', targetSelector: '[data-tutorial-target="study-input"]' },
