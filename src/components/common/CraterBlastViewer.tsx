    ...
    return (
      <div className="p-4 flex flex-col min-h-0">
        ...
        <div className="flex-1 rounded-2xl p-6 bg-slate-800/90 text-white text-center">
          <div className="w-16 h-16 mx-auto rounded-full bg-violet-600 hover:bg-violet-500 flex items-center justify-center text-3xl mb-4">💥</div>
          ...
          <div className="flex flex-wrap justify-center gap-2">
            ...
            {onEnlarge && (
              <button onClick={onEnlarge} className="px-4 py-2.5 rounded-xl bg-violet-600 hover:bg-violet-500 text-white font-medium hover:bg-violet-700">
  ...
  return (
    <div className="p-4 flex flex-col min-h-0">
      ...
      <div className="h-2 bg-stone-200 dark:bg-stone-700 rounded-full mb-4">
        <div className="h-full bg-violet-600 hover:bg-violet-500 rounded-full transition-all" style={{ width: `${((currentQuestion + 1) / displayedQuestions.length) * 100}%` }} />
      </div>
        ...
        <div className="flex justify-end">
          {!showResult ? (
            <button
              ...
              className="px-4 py-2.5 rounded-xl bg-violet-600 hover:bg-violet-500 text-white font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Check
            </button>
          ) : (
