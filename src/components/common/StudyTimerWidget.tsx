                ...
                {isCustom && (
                  <div className="flex gap-2 mb-3 sm:mb-4">
                    <input
                      ...
                      placeholder="Minutes"
                      disabled={isRunning}
                      className="flex-1 px-3 py-2 rounded-lg border border-stone-200 dark:border-stone-600 bg-white dark:bg-stone-800 text-stone-900 dark:text-stone-100 text-sm focus:ring-2 focus:ring-violet-500 focus:border-transparent"
                    />
                    <button
