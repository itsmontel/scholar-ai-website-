        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 sm:p-10 max-w-md w-full mx-4">
          <div className="flex flex-col items-center justify-center">
            ...
            <div className={`mt-6 px-4 py-3 rounded-xl w-full ${
              variant === 'studyPack' ? 'bg-amber-50 border border-amber-100' : 'bg-violet-50 border border-violet-100'
            }`}>
              <p className={`text-sm text-center ${variant === 'studyPack' ? 'text-amber-800' : 'text-violet-700'}`}>
                {variant === 'citations'
  ...
  return (
    <div className={`flex flex-col items-center justify-center space-y-4 ${className}`}>
      ...
      <div className="relative">
        <div className={`relative ${sizeClasses[size]} bg-gradient-to-br from-violet-500 to-violet-600 rounded-full flex items-center justify-center shadow-lg`}>
