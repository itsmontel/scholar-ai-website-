...
const ContactPage = ({ onNavigate, user, onLogout }: ContactPageProps) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50/80 via-stone-50 to-white dark:from-stone-950 dark:via-stone-900 dark:to-stone-900 transition-colors font-sans">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-stone-800 dark:text-stone-100 mb-4 tracking-tight">
            Contact <span className="bg-gradient-to-r from-indigo-600 to-violet-600 dark:from-indigo-400 dark:to-violet-400 bg-clip-text text-transparent">WriteScholar</span>
          </h1>
        ...
        <div className="bg-white dark:bg-stone-800/90 backdrop-blur-xl border border-stone-200/60 dark:border-stone-700/60 rounded-2xl p-6 sm:p-8 shadow-lg shadow-stone-200/50 dark:shadow-none mb-12">
          ...
          {/* Email Address */}
          <div className="bg-gradient-to-r from-indigo-50 to-violet-50 dark:from-indigo-900/20 dark:to-violet-900/20 border border-indigo-200/50 dark:border-violet-700/50 rounded-xl p-6 mb-8">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                <h3 className="text-lg font-semibold text-stone-800 dark:text-stone-100 mb-2">Email Address</h3>
                <p className="text-xl sm:text-2xl font-bold text-indigo-600 dark:text-indigo-400">support@writescholar.com</p>
...
Best regards,
[Your Name]`)}
              className="mt-4 inline-flex items-center gap-2 bg-gradient-to-r from-indigo-500 to-violet-600 hover:from-indigo-400 hover:to-violet-500 text-white font-semibold px-5 py-2.5 rounded-xl transition-all duration-200 shadow-lg shadow-violet-500/25 hover:shadow-violet-500/30"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
              </svg>
