...
const ContactPage = ({ onNavigate, user, onLogout }: ContactPageProps) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-rose-50/80 via-stone-50 to-white dark:from-stone-950 dark:via-stone-900 dark:to-stone-900 transition-colors font-sans">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        ...
        <div className="text-center mb-12 sm:mb-16">
          <span className="inline-flex items-center px-4 py-2 bg-rose-100 dark:bg-rose-900/30 text-rose-700 dark:text-rose-300 rounded-full text-sm font-medium mb-6 border border-rose-200/50 dark:border-rose-700/50">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-stone-800 dark:text-stone-100 mb-4 tracking-tight">
            Contact <span className="bg-gradient-to-r from-rose-600 to-pink-600 dark:from-rose-400 dark:to-pink-400 bg-clip-text text-transparent">WriteScholar</span>
          </h1>
        ...
        <div className="bg-white dark:bg-stone-800/90 backdrop-blur-xl border border-stone-200/60 dark:border-stone-700/60 rounded-2xl p-6 sm:p-8 shadow-lg shadow-stone-200/50 dark:shadow-none mb-12">
          <div className="text-center mb-8">
            <div className="w-16 h-16 sm:w-20 sm:h-20 bg-rose-100 dark:bg-rose-900/50 rounded-2xl flex items-center justify-center mx-auto mb-4">
              <svg className="w-8 h-8 sm:w-10 sm:h-10 text-rose-600 dark:text-rose-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
            </div>
          ...
          {/* Email Address */}
          <div className="bg-gradient-to-r from-rose-50 to-pink-50 dark:from-rose-900/20 dark:to-pink-900/20 border border-rose-200/50 dark:border-rose-700/50 rounded-xl p-6 mb-8">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                <h3 className="text-lg font-semibold text-stone-800 dark:text-stone-100 mb-2">Email Address</h3>
                <p className="text-xl sm:text-2xl font-bold text-rose-600 dark:text-rose-400">support@writescholar.com</p>
          ...
          <div className="space-y-6">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {/* Technical Support */}
              <div className="bg-stone-50 dark:bg-stone-800/50 border border-stone-200 dark:border-stone-700 rounded-xl p-4 hover:shadow-md hover:border-rose-200 dark:hover:border-rose-800/50 transition-all">
...
Best regards,
[Your Name]`)}
              className="mt-4 inline-flex items-center gap-2 bg-gradient-to-r from-rose-500 to-pink-600 hover:from-rose-400 hover:to-pink-500 text-white font-semibold px-5 py-2.5 rounded-xl transition-all duration-200 shadow-lg shadow-rose-500/25 hover:shadow-rose-500/30"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
              </svg>
        ...
        <div className="grid sm:grid-cols-3 gap-6 sm:gap-8">
          <div className="text-center p-6 bg-white dark:bg-stone-800/90 border border-stone-200 dark:border-stone-700 rounded-2xl">
            <div className="w-14 h-14 bg-rose-100 dark:bg-rose-900/50 rounded-2xl flex items-center justify-center mx-auto mb-4">
          ...
          <div className="text-center p-6 bg-white dark:bg-stone-800/90 border border-stone-200 dark:border-stone-700 rounded-2xl">
            ...
            <button
              ...
              className="text-xs text-rose-600 dark:text-rose-400 font-medium hover:underline mt-1"
            >
