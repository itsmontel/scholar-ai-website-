...
const CalculatorPage = ({ onNavigate, user, onLogout }: CalculatorPageProps) => {
  ...
  const scientificButtons = [
    { label: 'sin', onClick: () => handleFunction('sin'), className: 'bg-indigo-100 dark:bg-indigo-900/50 hover:bg-indigo-200 dark:hover:bg-indigo-800 text-indigo-800 dark:text-indigo-200 text-sm' },
    { label: 'cos', onClick: () => handleFunction('cos'), className: 'bg-indigo-100 dark:bg-indigo-900/50 hover:bg-indigo-200 dark:hover:bg-indigo-800 text-indigo-800 dark:text-indigo-200 text-sm' },
    { label: 'tan', onClick: () => handleFunction('tan'), className: 'bg-indigo-100 dark:bg-indigo-900/50 hover:bg-indigo-200 dark:hover:bg-indigo-800 text-indigo-800 dark:text-indigo-200 text-sm' },
    { label: '(', onClick: () => handleInput('('), className: 'bg-stone-200 dark:bg-stone-600 hover:bg-stone-300 dark:hover:bg-stone-500' },
    { label: ')', onClick: () => handleInput(')'), className: 'bg-stone-200 dark:bg-stone-600 hover:bg-stone-300 dark:hover:bg-stone-500' },
    { label: 'asin', onClick: () => handleFunction('asin'), className: 'bg-indigo-100 dark:bg-indigo-900/50 hover:bg-indigo-200 dark:hover:bg-indigo-800 text-indigo-800 dark:text-indigo-200 text-xs' },
    { label: 'acos', onClick: () => handleFunction('acos'), className: 'bg-indigo-100 dark:bg-indigo-900/50 hover:bg-indigo-200 dark:hover:bg-indigo-800 text-indigo-800 dark:text-indigo-200 text-xs' },
    { label: 'atan', onClick: () => handleFunction('atan'), className: 'bg-indigo-100 dark:bg-indigo-900/50 hover:bg-indigo-200 dark:hover:bg-indigo-800 text-indigo-800 dark:text-indigo-200 text-xs' },
    ...
    { label: 'ln', onClick: () => handleFunction('ln'), className: 'bg-teal-100 dark:bg-teal-900/50 hover:bg-teal-200 dark:hover:bg-teal-800 text-teal-800 dark:text-teal-200' },
    { label: 'log', onClick: () => handleFunction('log'), className: 'bg-teal-100 dark:bg-teal-900/50 hover:bg-teal-200 dark:hover:bg-teal-800 text-teal-800 dark:text-teal-200' },
    { label: '√', onClick: () => handleFunction('sqrt', '√('), className: 'bg-teal-100 dark:bg-teal-900/50 hover:bg-teal-200 dark:hover:bg-teal-800 text-teal-800 dark:text-teal-200' },
    ...
    { label: 'π', onClick: () => handleConstant('π', 'π'), className: 'bg-sky-100 dark:bg-sky-900/50 hover:bg-sky-200 dark:hover:bg-sky-800 text-sky-800 dark:text-sky-200' },
    { label: 'e', onClick: () => handleConstant('e', 'e'), className: 'bg-sky-100 dark:bg-sky-900/50 hover:bg-sky-200 dark:hover:bg-sky-800 text-sky-800 dark:text-sky-200' },
  ];
