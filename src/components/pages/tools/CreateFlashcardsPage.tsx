...
const THEMES: Record<CardTheme, {
  ...
  violet: {
    ...
    cardBg: 'from-violet-50/80 to-violet-50/80 dark:from-violet-900/20 dark:to-violet-900/20',
    ...
    saveBtnTo: 'to-violet-600',
    saveBtnHoverFrom: 'hover:from-violet-500',
    saveBtnHoverTo: 'hover:to-violet-500',
  ...
  rose: {
    dot: 'bg-violet-500',
    ring: 'ring-violet-500',
    cardBg: 'from-violet-50/80 to-fuchsia-50/80 dark:from-violet-900/20 dark:to-fuchsia-900/20',
    cardBorder: 'border-violet-200 dark:border-violet-700/50',
    labelText: 'text-violet-600 dark:text-violet-400',
    addBtn: 'bg-violet-600',
    addBtnHover: 'hover:bg-violet-700',
    saveBtnFrom: 'from-violet-500',
    saveBtnTo: 'to-fuchsia-600',
    saveBtnHoverFrom: 'hover:from-violet-400',
    saveBtnHoverTo: 'hover:to-fuchsia-500',
    saveShadow: 'shadow-violet-500/25',
    accentText: 'text-violet-600 dark:text-violet-400',
    deckBadge: 'bg-violet-100 dark:bg-violet-900/40 text-violet-700 dark:text-violet-300',
  },
...
const THEME_DOTS: Record<CardTheme, string> = {
  ...
  blue: 'bg-gradient-to-br from-violet-400 to-violet-600',
  amber: 'bg-gradient-to-br from-amber-400 to-orange-500',
  rose: 'bg-gradient-to-br from-violet-400 to-fuchsia-600',
};
