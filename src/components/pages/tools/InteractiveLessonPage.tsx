              ...
              <div className="mt-8 sm:mt-10">
                ...
                <div className="relative bg-white dark:bg-stone-800 rounded-2xl overflow-hidden shadow-xl shadow-stone-200/50 dark:shadow-stone-900/50 border border-stone-200/60 dark:border-stone-600/50 max-w-3xl mx-auto">
                  <div className="bg-gradient-to-br from-violet-50/50 to-purple-50/50 dark:from-violet-900/20 dark:to-purple-900/20 flex items-center justify-center aspect-video min-h-[200px] sm:min-h-[320px]">
                    <video autoPlay loop muted playsInline className="w-full h-full object-contain" title="WriteScholar Lesson Generator — Turn text into interactive lessons" aria-label="WriteScholar Lesson Generator — Turn text into interactive lessons">
                      <source src="/writescholar-quiz-generator-demo.mp4" type="video/mp4" />
                    </video>
                  </div>
                  <div className="px-4 py-3.5 border-t border-stone-100 dark:border-stone-700/80">
                    <p className="text-sm font-semibold text-stone-800 dark:text-stone-100">Interactive Lesson Generator</p>
                    <p className="text-xs text-stone-500 dark:text-stone-400 mt-0.5">Paste your notes or textbook content, then get 3 unique lesson styles in one click.</p>
                  </div>
                </div>
              </div>
            </div>
