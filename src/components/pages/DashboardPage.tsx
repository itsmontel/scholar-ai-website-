...
const Dashboard = ({ onNavigate, user, onLogout, onUserUpdate, initialMode = 'analyze' }: DashboardProps) => {
  ...
  return (
    <div className="min-h-screen relative transition-colors font-sans overflow-x-hidden">
      ...
      {showQuickReview && !showWelcomeTutorial && !showInteractiveTutorial && (
        <QuickReviewModal
          userName={getDisplayNameForGreeting(user)}
          userId={user?.id}
                  ...
                  <div className="relative mb-2 max-w-3xl mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-3 mt-4">
                      ...
                      <button
                        ...
                        className="px-8 sm:px-10 py-3.5 rounded-2xl flex items-center justify-center gap-2 transition-all duration-200 font-bold text-base bg-amber-600 hover:bg-amber-500 disabled:bg-stone-400 dark:disabled:bg-stone-600 text-white shadow-lg shadow-amber-500/30 hover:shadow-xl hover:shadow-amber-500/40 hover:-translate-y-0.5 active:scale-[0.98] disabled:hover:translate-y-0 disabled:cursor-not-allowed"
                      >
                        {isGeneratingStudyPack ? (
                          <>
                            <svg className="animate-spin w-5 h-5" fill="none" viewBox="0 0 24 24"><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" /><path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z" /></svg>
            ...
            <div className="text-center py-8 sm:py-12 bg-white/90 dark:bg-stone-800/95 backdrop-blur-xl rounded-2xl sm:rounded-3xl border border-white/50 dark:border-stone-600/50 shadow-xl">
              ...
              <div className="flex flex-col sm:flex-row gap-2 justify-center items-center flex-wrap">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-4 sm:px-5 py-2.5 bg-amber-600 hover:bg-amber-500 text-white font-semibold rounded-xl transition-all shadow-md shadow-amber-500/20 hover:shadow-lg text-sm"
                >
                  <span>📦</span>
                  Generate Study Pack
                </button>
                <button
                  ...
                  className="inline-flex items-center gap-2 px-4 sm:px-5 py-2.5 bg-sky-600 hover:bg-sky-500 text-white font-semibold rounded-xl transition-all shadow-md shadow-sky-500/20 hover:shadow-lg text-sm"
                >
                  <span>📚</span>
                  Find Citations
                </button>
