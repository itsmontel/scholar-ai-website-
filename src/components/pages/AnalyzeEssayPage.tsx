              ...
              <div className="relative rounded-b-2xl bg-white/95 dark:bg-stone-900/70 p-4 sm:p-8">
                ...
                <div className="relative lg:grid lg:grid-cols-[minmax(0,220px)_minmax(0,48rem)_minmax(0,220px)] lg:gap-8 xl:gap-10 lg:items-start">
                  ...
                  <div className="min-w-0">
                    ...
                    >
                      <span className="text-emerald-700 dark:text-emerald-400">Paste</span> or <span className="text-sky-700 dark:text-sky-400">upload</span> your essay, get{' '}
                    ...
                    {!user && uploadedFileName && (
                      <div className="relative max-w-3xl mx-auto mb-4 rounded-xl border border-stone-200/90 dark:border-stone-600 bg-stone-50/90 dark:bg-stone-800/50 px-4 py-3 flex flex-col sm:flex-row items-center justify-center gap-3 text-sm">
                        ...
                        <div className="flex items-center gap-2">
                          <button type="button" onClick={() => analyzeFileInputRef.current?.click()} className="text-violet-600 dark:text-violet-400 font-semibold hover:underline">
                            Change file
                          </button>
                        ...
                        <div className="flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-4 sm:gap-5">
                          <div className="flex items-center gap-3 flex-wrap justify-center sm:justify-start">
                            <button
                              ...
                              className="flex items-center gap-2.5 px-6 py-3.5 rounded-xl font-semibold text-sm transition-all border shadow-md disabled:opacity-60 disabled:pointer-events-none disabled:hover:translate-y-0 bg-violet-600 dark:bg-violet-500 text-white border-violet-400/40 shadow-lg shadow-violet-600/25 ring-1 ring-violet-400/30 hover:bg-violet-500 dark:hover:bg-violet-400 hover:shadow-xl hover:shadow-violet-600/20 hover:-translate-y-0.5 active:translate-y-0"
                            >
                              {isParsingAnalyzeDoc ? (
                            ...
                            {user && (
                              <button type="button" onClick={() => onNavigate('upload')} className="text-xs sm:text-sm font-medium text-violet-600 dark:text-violet-400 hover:underline px-1">
                                Library upload →
                              </button>
                            )}
                        ...
                        >
                          <div className="flex flex-col sm:flex-row items-center justify-center gap-5 sm:gap-7">
                            ...
                            <div className="text-left sm:text-left min-w-0 max-w-md">
                              <p className="text-lg sm:text-xl font-bold tracking-tight text-violet-800 dark:text-violet-200">Drop your document here</p>
                      ...
                      <div className="mt-4 flex justify-center">
                        <button
                          ...
                          className={`px-8 py-3.5 rounded-xl font-semibold text-base ${
                            isTextValid() ? 'bg-violet-700 hover:bg-violet-800 text-white shadow-md shadow-violet-900/15 ring-1 ring-violet-900/10' : 'bg-stone-200 text-stone-400 cursor-not-allowed'
                          }`}
                        >
                          Analyze Text
                        </button>
      ...
      {showSignupPrompt && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-stone-800 rounded-3xl shadow-2xl border border-stone-200 dark:border-stone-600 max-w-md w-full p-8 text-center relative animate-in zoom-in-95 fade-in duration-300">
            ...
            <div className="w-20 h-20 bg-violet-100 dark:bg-violet-900/40 rounded-2xl flex items-center justify-center mx-auto mb-6 border border-violet-200/60 dark:border-violet-800/50">
