            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3 p-3 bg-green-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600">Excellent introduction that clearly establishes the scope and focus of your research. The thesis statement is well-positioned and compelling.</p>
                </div>
              </div>
              <div className="flex items-start space-x-3 p-3 bg-yellow-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600">The methodology section could benefit from more detailed explanation of your data collection process and sample size justification.</p>
                </div>
              </div>
              <div className="flex items-start space-x-3 p-3 bg-blue-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600">Consider adding more recent studies (2022-2023) to strengthen your literature review section and current relevance.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3 p-3 bg-green-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600">Your economic analysis shows clear logical progression and solid theoretical foundation. The use of econometric models is appropriate.</p>
                </div>
              </div>
              <div className="flex items-start space-x-3 p-3 bg-yellow-50 rounded-lg">
                <div className="w-2 h-2 bg-yellow-500 rounded-full mt-2"></div>
                <div>
                  ...
                  <p className="text-xs text-gray-600">Consider adding regression plots or time-series charts to better illustrate your statistical findings and trends.</p>
                </div>
              </div>
              <div className="flex items-start space-x-3 p-3 bg-blue-50 rounded-lg">
                <div className="w-2 h-2 bg-blue-500 rounded-full mt-2"></div>
                <div>
                  ...
                  <p className="text-xs text-gray-600">Your conclusion effectively synthesizes findings but could better address limitations and suggest future research directions.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="text-center mb-20">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center group">
              ...
              <p className="text-gray-600">Upload your academic document in PDF, Word, or paste your text directly into our secure platform.</p>
            </div>
            <div className="text-center group">
              ...
              <p className="text-gray-600">Our advanced AI analyzes your writing for structure, clarity, grammar, citation style, and academic rigor.</p>
            </div>
            <div className="text-center group">
              ...
              <p className="text-gray-600">Get detailed, professor-style annotations and suggestions with explanations for every recommendation.</p>
            </div>
            <div className="text-center group">
              ...
              <p className="text-gray-600">Apply suggestions and re-analyze to continuously enhance your academic writing skills and quality.</p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-600 hover:text-gray-900 text-sm transition-colors">Writing Guide</a></li>
                <li><a href="#" className="text-gray-600 hover:text-gray-900 text-sm transition-colors">API Docs</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-600 hover:text-gray-900 text-sm transition-colors">Cookie Policy</a></li>
              </ul>
            </div>
          </div>
        </div>
