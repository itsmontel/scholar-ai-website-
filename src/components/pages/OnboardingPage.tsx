...
const OnboardingPage = ({ user, onComplete, onUserUpdate }: OnboardingPageProps) => {
  ...
  if (phase === 'transition' || phase === 'done') {
    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-gradient-to-br from-indigo-600 via-violet-600 to-purple-700 overflow-hidden animate-transBgIn">
  ...
  /* ──────────── PROFILE FORM ──────────── */
  return (
    <div className="min-h-screen flex flex-col relative font-sans bg-gradient-to-b from-blue-50/60 via-stone-50 to-white dark:from-stone-950 dark:via-stone-900 dark:to-stone-900">
          ...
          <div className="bg-white dark:bg-stone-800 rounded-3xl border border-stone-200 dark:border-stone-600 shadow-xl dark:shadow-stone-900/50 p-6 sm:p-8">
            ...
            <div className="text-center mb-6">
              ...
              <div className="space-y-4">
                ...
                <label className="block text-sm font-medium text-stone-600 dark:text-stone-400 mb-2">Your name</label>
                  ...
                  className="w-full px-5 py-4 rounded-2xl border-2 border-stone-200 dark:border-stone-600 bg-stone-50 dark:bg-stone-700/50 focus:border-indigo-500 dark:focus:border-violet-500 focus:ring-2 focus:ring-indigo-500/20 transition-all text-base text-stone-800 dark:text-stone-100 placeholder-stone-400 dark:placeholder-stone-500"
                  autoFocus
                  />
                </div>
                <div>
                <label className="block text-sm font-medium text-stone-600 dark:text-stone-400 mb-2">Pick a username</label>
                  ...
                  className={`w-full px-5 py-4 rounded-2xl border-2 bg-stone-50 dark:bg-stone-700/50 focus:ring-2 transition-all text-base text-stone-800 dark:text-stone-100 placeholder-stone-400 dark:placeholder-stone-500 ${
                    usernameError
                      ...
                      : 'border-stone-200 dark:border-stone-600 focus:border-indigo-500 dark:focus:border-violet-500 focus:ring-indigo-500/20'
                  }`}
            ...
            <div className="mt-8 flex justify-center">
              <button
                ...
                className="w-full sm:w-auto px-10 py-3.5 bg-gradient-to-r from-indigo-500 to-violet-600 hover:from-indigo-500/90 hover:to-violet-600/90 text-white rounded-2xl font-bold text-base shadow-lg shadow-indigo-500/25 transition-all disabled:opacity-40 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {isSaving ? (
                  <>
