              ...
              <div className="flex items-center gap-2 flex-1 sm:flex-initial justify-end sm:justify-start">
                {isPaidUser && (
                  <>
                    ...
                    <button
                      ...
                      className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl bg-violet-50 dark:bg-violet-900/20 text-violet-700 dark:text-violet-300 hover:bg-violet-100 dark:hover:bg-violet-900/30 font-medium text-xs sm:text-sm transition-colors border border-violet-200 dark:border-violet-800"
                    >
                ...
                {!isPaidUser && (
                  <button
                    ...
                    title="Upgrade to export to PDF and Word"
                  >
                    ...
                    Upgrade to export to PDF and Word
                  </button>
                )}
              </div>
            </div>
