...
const AcademicAIApp = () => {
  ...
  const pageMeta: Record<string, { title: string; description: string }> = {
    landing: { title: 'Block Websites Until You Study | Earn Your Screen Time | WriteScholar', description: 'Block YouTube, TikTok and distracting sites until you study. Earn your screen time by answering quiz questions from your own notes. Plus AI flashcards, quizzes and essay feedback. Free to try.' },
    ...
    'focus-mode': { title: 'Block Distracting Websites Until You Answer Study Questions | Focus Mode', description: 'Block YouTube, TikTok, Instagram and Reddit until you answer quiz questions from your own notes. Study before social media. Earn your screen time. Pro: 10 sites. Premium: unlimited.' },
