...
export default function InteractiveDocumentAnalysis({ onNavigate }: InteractiveDocumentAnalysisProps) {
  ...
  return (
    <div className="rounded-2xl overflow-hidden shadow-xl border border-gray-200 dark:border-stone-600 bg-white dark:bg-stone-900 min-w-0 max-w-full">
      ...
      <div className="bg-gray-900 dark:bg-stone-950 px-4 sm:px-6 py-5">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 min-w-0">
          ...
          <button type="button" className="px-3 sm:px-4 py-2 bg-white/10 hover:bg-white/20 rounded-lg transition-colors flex items-center gap-2 text-xs sm:text-sm font-medium text-white shrink-0">
