...
function subjectPage(s: SubjectMeta): ProgrammaticPageConfig {
  return {
    ...
    related: [
      { label: 'AI Flashcard Maker', href: '/tools/create-flashcards', teaser: `Build flashcard decks from any ${s.niceName} notes.` },
      ...
      { label: 'Pomodoro Timer', href: '/tools/pomodoro-timer', teaser: 'Focus + break intervals for study sessions.' },
    ],
