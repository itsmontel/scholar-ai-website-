...
struct MemoryGameView: View {
    ...
    // Dynamic based on hard mode
    private var totalPairs: Int { game.totalPairs }
    private var gridColumns: Int { game.gridColumns }
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            VStack(spacing: 8) {
                ...
                Text("Find all \(totalPairs) pairs to win")
            ...
            // Cards Grid - 4x4 (normal) or 4x5 (hard mode)
            LazyVGrid(
                columns: Array(repeating: GridItem(.flexible(), spacing: 10), count: gridColumns),
                spacing: 10
            ) {
