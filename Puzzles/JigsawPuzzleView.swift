...
struct JigsawPuzzleView: View {
    ...
    private var totalPieces: Int { puzzle.totalPieces }
    ...
    private var puzzleBoardView: some View {
        // Smaller pieces for 4x4 grid in hard mode
        let pieceSize: CGFloat = puzzle.isHardMode ? 55 : 70
    ...
    private var pieceTrayView: some View {
        // Smaller pieces for 4x4 grid in hard mode
        let pieceSize: CGFloat = puzzle.isHardMode ? 45 : 55
